    ...
    },
    {
      path: '/sysadminindex', name: 'sysadminindex', meta: { title: "主页" }, component: () => import('@/components/sysadminIndex'),
        ...
        children: [
          ...
          { path: '/sysadminStudentInfo', name: 'sysadminStudentInfo', meta: { title: "学生信息详情",role:["admin"]  }, component: () => import('@/components/userInformation/student/studentInfo') },
          ...
          { path: '/sysadminCompanyInfo', name: 'sysadminCompanyInfo', meta: { title: "企业详情",role:["admin"]  }, component: () => import('@/components/userInformation/company/companyInfo') },
          { path: '/sysadminAdminList', name: 'sysadminAdminList', meta: { title: "管理员列表",role:["admin"]  }, component: () => import('@/components/userInformation/admin/adminList') },
          { path: '/sysadminAdminInfo', name: 'sysadminAdminInfo', meta: { title: "管理员详情",role:["admin"]  }, component: () => import('@/components/userInformation/admin/adminInfo') },
          { path: '/sysadminTrainingList', name: 'sysadminTrainingList', meta: { title: "培训信息列表" ,role:["admin"] }, component: () => import('@/components/training/trainingList') },
          { path: '/sysadminTrainingInfo', name: 'sysadminTrainingInfo', meta: { title: "培训信息详情",role:["admin"]  }, component: () => import('@/components/training/trainingInfo') },
          { path: '/sysadminConsultList', name: 'sysadminConsultList', meta: { title: "咨询信息列表",role:["admin"]  }, component: () => import('@/components/consult/consultList') },
          ...
          { path: '/sysadminRecruitmentList', name: 'sysadminRecruitmentList', meta: { title: "招聘信息列表" ,role:["admin"] }, component: () => import('@/components/recruitment/recruitmentList') },
          { path: '/sysadminRecruitmentInfo', name: 'sysadminRecruitmentInfo', meta: { title: "招聘信息详情",role:["admin"]  }, component: () => import('@/components/recruitment/recruitmentInfo') },
